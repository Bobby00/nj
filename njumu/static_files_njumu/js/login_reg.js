var nameLabel = document.querySelector('#registerNameLabel'),
name = document.querySelector('#registerName'),

phoneLabel = document.querySelector('#registerPhoneLabel'),
phoneNumber = document.querySelector('#phoneNumber'),


passwordLabel2 = document.querySelector('#loginPasswordLabel2'), 
password2 = document.querySelector('#loginPassword2');
